...
\title{Numerical Methods for PDEs \\ \large Lecture notes of the course held by prof. L. Heltai \\ \normalsize University of Pisa}
\author{}
...
\input{Files/1-overview}

\input{Files/2-error-estimates-lax-milgram}

\input{Files/3-a-posteriori-error-estimates}

\input{Files/4-discontinuous-galerkin-methods}

\input{Files/5-saddle-point-problems}
